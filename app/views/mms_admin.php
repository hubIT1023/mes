...
<body class="bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100 flex h-screen">
  ...
  <aside class="w-64 bg-white dark:bg-gray-800 shadow-lg flex flex-col">
    ...
    <nav class="flex-grow p-4 space-y-2">
      <a href="#" class="flex items-center p-3 rounded-lg hover:bg-blue-100 dark:hover:bg-blue-900 transition">
        <i class="fas fa-boxes mr-3 text-blue-600"></i> Assets
      </a>
      <a href="http://localhost/mes/app/views/forms_mms/config_maint_form.php" class="flex items-center p-3 rounded-lg hover:bg-blue-100 dark:hover:bg-blue-900 transition">
    ...
    <div class="p-4 border-t border-gray-200 dark:border-gray-700">
      <a href="/mes/logout" class="flex items-center p-3 rounded-lg hover:bg-red-100 dark:hover:bg-red-900 text-red-600 transition">
  ...
  <div class="flex-grow flex flex-col">
    ...
    <header class="w-full bg-white dark:bg-gray-800 shadow-md py-4 px-6 flex items-center justify-between">
      ...
      <div class="flex items-center gap-4">
        <a href="/mes/hub_portal" class="text-gray-700 dark:text-gray-300 hover:text-blue-500 font-medium transition">
          Hub Portal
        </a>
        <button class="text-gray-600 dark:text-gray-300 hover:text-blue-500 transition" aria-label="Notifications">
          <i class="fas fa-bell text-xl"></i>
        </button>
        <button class="text-gray-600 dark:text-gray-300 hover:text-blue-500 transition" aria-label="Profile">
    ...
    <main class="flex-grow p-6 overflow-y-auto">
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow hover:shadow-lg transition flex flex-col">
          ...
          <a href="mes/form_mms/addAsset" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 inline-block text-center">Go</a>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow hover:shadow-lg transition flex flex-col">
          ...
          <a href="#" class="px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 inline-block text-center">Go</a>
        </div>
