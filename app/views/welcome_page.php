<?php
// Set base URL dynamically; if using front controller, $baseUrl may already be defined
$baseUrl = '/mes'; // adjust if needed
?>
...
<head>
  ...
  <link rel="icon" href="<?= $baseUrl ?>/app/Assets/img/favicon.ico" type="image/x-icon">
    ...
    <section class="choices">
      <div class="cards">
        ...
        <article class="card">
          ...
          <a class="button" href="<?= $baseUrl ?>/register">Create Account</a>
        </article>
        ...
        <article class="card">
          ...
          <a class="button" href="<?= $baseUrl ?>/signin">Sign In</a>
        </article>
        ...
        <article class="card">
          ...
          <a class="button" href="<?= $baseUrl ?>/demo/demo_dashboard">Try Demo</a>
        </article>
      </div>
    </section>
  </main>
