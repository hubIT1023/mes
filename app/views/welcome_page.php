...
<head>
  ...
  header { display: flex; justify-content: center; align-items: center; height: 100px;
    background: rgba(255,255,255,0.9); backdrop-filter: blur(8px); box-shadow: 0 2px 6px rgba(0,0,0,0.15);
  ...
  .hero h1 { font-size: 2.8rem; margin-bottom:0.8rem; font-weight:700;
  ...
  .card { background: rgba(186,234,246,0.25); border:1px solid #e2e8f0; border-radius:16px; padding:2rem; box-shadow:0 8px 20px rgba(0,0,0,0.12); text-align:center; transition: transform 0.3s ease, box-shadow 0.3s ease; }
  .card:hover { transform: translateY(-6px); box-shadow:0 16px 32px rgba(0,0,0,0.2); }
  ...
  .button { display:inline-block; padding:0.8rem 1.4rem; border-radius:10px; text-decoration:none; font-weight:600; font-size:1rem; color:#fff; background:linear-gradient(90deg,#2563eb,#3b82f6); transition: transform 0.2s ease, background 0.3s ease; }
  .button:hover { background:linear-gradient(90deg,#1e40af,#2563eb); transform: scale(1.05); }

  footer { text-align:center; padding:2rem; font-size:0.9rem; color:#94a3b8; margin-top:4rem; border-top:1px solid rgba(255,255,255,0.1); background:rgba(15,23,42,0.9); backdrop-filter:blur(6px); }
  </style>
</head>
<body>
  <header>
