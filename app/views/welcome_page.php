...
<head>
	...
	<link rel="icon" href="/mes/app/Assets/img/favicon.png" type="image/x-icon">
...
<body class="font-sans text-slate-900 bg-slate-50">
    ...
    <nav class="sticky top-0 z-50 bg-white border-b border-slate-200 py-4">
		<div class="container mx-auto px-6 flex justify-between items-center">
			<!-- LOGO REPLACED HERE -->
			<div>
				<img src="/mes/app/Assets/img/hubIT_logo-v5.png" 
					 alt="HubIT.ONLINE" 
					 class="h-12 w-auto">
			</div>
			<!-- Rest unchanged -->
			...
			<div>
				<!--a href="#" class="bg-blue-600 text-white px-5 py-2.5 rounded-lg font-semibold hover:bg-blue-700 transition">Get Started</a-->
				 <a  href="/mes/register" class="w-full md:w-auto bg-blue-600 text-white px-8 py-4 rounded-lg text-lg font-bold hover:bg-blue-700">Register</a>
				<a href="/mes/signin" class="w-full md:w-auto bg-blue-600 text-white px-8 py-4 rounded-lg text-lg font-bold hover:bg-blue-700">Sign-In</a>
   ...
   <section class="py-12 bg-white">
		<div class="container mx-auto px-6">
			<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 -mt-24">
				...
				<div class="bg-slate-800 rounded-xl shadow-2xl overflow-hidden border-4 border-slate-700 group">
					<div class="relative overflow-hidden h-[300px]"> <!-- Fixed height -->
						<img src="/mes/app/Assets/img/work_order_details.JPG" 
				...
				<div class="bg-slate-800 rounded-xl shadow-2xl overflow-hidden border-4 border-slate-700 group">
					<div class="relative overflow-hidden h-[300px]"> <!-- Fixed height -->
						<img src="/mes/app/Assets/img/prod_machineries.JPG" 
				...
				<div class="bg-slate-800 rounded-xl shadow-2xl overflow-hidden border-4 border-slate-700 group">
					<div class="relative overflow-hidden h-[300px]"> <!-- Fixed height -->
						<img src="/mes/app/Assets/img/condition_monitonig.JPG" 
