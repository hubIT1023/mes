...
<div class="modal-body">
    ...
    <div class="row mb-3">
        <div class="col">
            ...
            <input type="text" id="lw_modal_location" class="form-control" readonly />
        </div>
        <div class="col">
            <label class="form-label">Group</label>
            <input type="text" id="lw_modal_group" class="form-control" readonly />
        </div>
    </div>
    ...
    <div class="row mb-3">
        <div class="col">
            ...
            <input type="text" id="lw_ipt_entity" class="form-control" readonly />
        </div>
        <div class="col">
            <label class="form-label">Asset ID</label>
            <input type="text" id="lw_modal_asset_id_display" class="form-control" readonly />
        </div>
    </div>
