    ...
    public function getFilterOptions($tenantId) {
        ...
        $types = $pdo->prepare("
            ...
            WHERE tenant_id = :tenant_id 
              ...
              AND LTRIM(RTRIM(maintenance_type)) != ''
        ...
        $techs = $pdo->prepare("
            ...
            WHERE tenant_id = :tenant_id 
              ...
              AND LTRIM(RTRIM(technician_name)) != ''
...
public function generateRoutineWorkOrders($tenantId, $filters = []) {
    ...
    foreach ($rows as $row) {
        ...
        $insertStmt->execute([
            ...
            'work_order'    => $row['work_order'],  // goes to work_order_ref
            'tech'          => $row['technician'],
